...
wire   [0:0] tmp_i_56_fu_191_p2;
reg   [0:0] tmp_i_56_reg_263;
wire   [0:0] tmp_35_i_fu_201_p2;
...
wire   [15:0] tmp_9_fu_232_p2;
reg   [15:0] tmp_9_reg_292;
...
wire   [63:0] tmp_36_i_fu_217_p1;
reg    ap_block_pp0_stage0_01001;
wire   [32:0] lhs_V_cast_i_fu_171_p1;
wire   [32:0] tmp_34_cast_i_fu_197_p1;
wire   [15:0] storemerge_i_fu_222_p3;
wire   [15:0] tmp_37_i_fu_228_p1;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_206_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_buffer_addr_reg_281 <= tmp_36_i_fu_217_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_i_56_reg_263 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_35_i_reg_268 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_35_i_reg_268 == 1'd1) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_35_i_reg_268 == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_buffer_we1 = 1'b1;
    end else begin
        dst_buffer_we1 = 1'b0;
    end
...
assign Vdst_data_stream_V_din = tmp_9_reg_292;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((tmp_35_i_reg_268 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((tmp_35_i_reg_268 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((tmp_35_i_reg_268 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((src_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state7_pp0_stage0_iter3 = ((tmp_35_i_reg_268 == 1'd1) & (1'b0 == Vdst_data_stream_V_full_n));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign dst_buffer_address0 = tmp_36_i_fu_217_p1;

assign exitcond3_i_fu_180_p2 = ((t_V_reg_149 == rows_V_reg_238) ? 1'b1 : 1'b0);

assign exitcond_i_fu_206_p2 = ((t_V_3_reg_160 == cols_V_reg_244) ? 1'b1 : 1'b0);

assign i_V_fu_185_p2 = (t_V_reg_149 + 32'd1);

assign j_V_fu_211_p2 = (t_V_3_reg_160 + 32'd1);

assign lhs_V_cast_i_fu_171_p1 = rows_V_reg_238;

assign r_V_fu_174_p2 = ($signed(lhs_V_cast_i_fu_171_p1) + $signed(33'd8589934591));

assign storemerge_i_fu_222_p3 = ((tmp_i_56_reg_263[0:0] === 1'b1) ? 16'd0 : dst_buffer_load_reg_287);

assign tmp_34_cast_i_fu_197_p1 = t_V_reg_149;

assign tmp_35_i_fu_201_p2 = ((tmp_34_cast_i_fu_197_p1 == r_V_reg_249) ? 1'b1 : 1'b0);

assign tmp_36_i_fu_217_p1 = t_V_3_reg_160;

assign tmp_37_i_fu_228_p1 = src_data_stream_V_dout;

assign tmp_9_fu_232_p2 = (storemerge_i_fu_222_p3 + tmp_37_i_fu_228_p1);

assign tmp_i_56_fu_191_p2 = ((t_V_reg_149 == 32'd0) ? 1'b1 : 1'b0);
