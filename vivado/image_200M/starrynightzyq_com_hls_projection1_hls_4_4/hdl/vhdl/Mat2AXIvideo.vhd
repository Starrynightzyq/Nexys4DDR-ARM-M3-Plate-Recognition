...
architecture behav of Mat2AXIvideo is 
    ...
    signal exitcond4_i_fu_202_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    ap_ready_assign_proc : process(AXI_video_strm_V_data_V_1_ack_in, AXI_video_strm_V_keep_V_1_ack_in, AXI_video_strm_V_strb_V_1_ack_in, AXI_video_strm_V_user_V_1_ack_in, AXI_video_strm_V_last_V_1_ack_in, AXI_video_strm_V_id_V_1_ack_in, AXI_video_strm_V_dest_V_1_ack_in, exitcond4_i_fu_202_p2, ap_CS_fsm_state3)
    begin
        if ((not(((ap_const_logic_0 = AXI_video_strm_V_data_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_dest_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_id_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_last_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_user_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_strb_V_1_ack_in) or (ap_const_logic_0 = AXI_video_strm_V_keep_V_1_ack_in))) and (exitcond4_i_fu_202_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    exitcond4_i_fu_202_p2 <= "1" when (t_V_reg_166 = rows_V_reg_249) else "0";
    exitcond_i_fu_213_p2 <= "1" when (t_V_4_reg_177 = cols_V_reg_254) else "0";
    ...
    j_V_fu_218_p2 <= std_logic_vector(unsigned(t_V_4_reg_177) + unsigned(ap_const_lv32_1));
    ...
    tmp_cast_i_fu_224_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_4_reg_177),33));
end behav;
