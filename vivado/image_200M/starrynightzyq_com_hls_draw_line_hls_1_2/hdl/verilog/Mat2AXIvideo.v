...
reg   [31:0] rows_V_reg_249;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_254;
wire   [32:0] r_V_fu_196_p2;
reg   [32:0] r_V_reg_260;
wire    ap_CS_fsm_state2;
wire   [0:0] exitcond3_i_fu_202_p2;
wire    ap_CS_fsm_state3;
reg    ap_block_state3;
wire   [31:0] i_V_fu_207_p2;
...
wire   [32:0] lhs_V_cast_i_fu_193_p1;
wire   [32:0] tmp_cast_i_fu_224_p1;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond3_i_fu_202_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond_i_reg_274 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((exitcond_i_reg_274 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_state1 = ((img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
always @ (*) begin
    ap_block_state5_io = ((exitcond_i_reg_274 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((exitcond_i_reg_274 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((exitcond_i_reg_274_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_228_p2 = ((tmp_cast_i_fu_224_p1 == r_V_reg_260) ? 1'b1 : 1'b0);

assign exitcond3_i_fu_202_p2 = ((t_V_reg_166 == rows_V_reg_249) ? 1'b1 : 1'b0);

assign exitcond_i_fu_213_p2 = ((t_V_3_reg_177 == cols_V_reg_254) ? 1'b1 : 1'b0);

assign i_V_fu_207_p2 = (t_V_reg_166 + 32'd1);

assign j_V_fu_218_p2 = (t_V_3_reg_177 + 32'd1);

assign lhs_V_cast_i_fu_193_p1 = cols_V_reg_254;
...
assign r_V_fu_196_p2 = ($signed(lhs_V_cast_i_fu_193_p1) + $signed(33'd8589934591));

assign tmp_cast_i_fu_224_p1 = t_V_3_reg_177;
