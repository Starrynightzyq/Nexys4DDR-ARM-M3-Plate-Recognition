...
wire   [0:0] tmp_10_fu_223_p2;
wire   [0:0] tmp_fu_247_p2;
wire   [15:0] tmp_7_fu_251_p2;
wire   [15:0] diff_sum_t_3_fu_257_p3;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
assign diff_sum = ((tmp_s_reg_313_pp0_iter2_reg[0:0] === 1'b1) ? 16'd0 : diff_sum_t_3_fu_257_p3);

assign diff_sum_t_2_fu_265_p3 = ((tmp_s_reg_313_pp0_iter2_reg[0:0] === 1'b1) ? 16'd0 : diff_sum_t_3_fu_257_p3);

assign diff_sum_t_3_fu_257_p3 = ((tmp_fu_247_p2[0:0] === 1'b1) ? tmp_7_fu_251_p2 : diff_sum_t_fu_84);
...
assign mask_0_address0 = sum_cast_fu_234_p1;

assign or_cond_fu_229_p2 = (tmp_6_reg_294 & tmp_10_fu_223_p2);
...
assign tmp_10_fu_223_p2 = ((t_V_1_reg_126 == 5'd27) ? 1'b1 : 1'b0);
...
assign tmp_fu_247_p2 = (tmp_2_reg_332 ^ mask_0_load_reg_337);
