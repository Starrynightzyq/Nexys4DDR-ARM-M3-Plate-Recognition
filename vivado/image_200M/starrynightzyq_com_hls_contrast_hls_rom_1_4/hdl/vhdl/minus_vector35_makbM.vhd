...
entity minus_vector35_makbM_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 10; 
...
architecture rtl of minus_vector35_makbM_rom is 
...
entity minus_vector35_makbM is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of minus_vector35_makbM is
    component minus_vector35_makbM_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    minus_vector35_makbM_rom_U :  component minus_vector35_makbM_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
