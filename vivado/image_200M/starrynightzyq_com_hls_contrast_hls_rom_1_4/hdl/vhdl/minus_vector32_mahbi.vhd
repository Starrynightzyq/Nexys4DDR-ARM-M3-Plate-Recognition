...
entity minus_vector32_mahbi_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 10; 
...
architecture rtl of minus_vector32_mahbi_rom is 
...
entity minus_vector32_mahbi is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of minus_vector32_mahbi is
    component minus_vector32_mahbi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    minus_vector32_mahbi_rom_U :  component minus_vector32_mahbi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
