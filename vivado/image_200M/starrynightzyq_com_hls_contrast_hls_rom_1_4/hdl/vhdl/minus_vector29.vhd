...
architecture behav of minus_vector29 is 
    ...
    signal mask_3_load_reg_337 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component minus_vector29_maeOg IS
    generic (
        DataWidth : INTEGER;
...
begin
    mask_3_U : component minus_vector29_maeOg
    generic map (
        DataWidth => 1,
        AddressRange => 784,
        AddressWidth => 10)
    ...
    mask_3_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
    ...
    tmp_fu_247_p2 <= (tmp_2_reg_332 xor mask_3_load_reg_337);
