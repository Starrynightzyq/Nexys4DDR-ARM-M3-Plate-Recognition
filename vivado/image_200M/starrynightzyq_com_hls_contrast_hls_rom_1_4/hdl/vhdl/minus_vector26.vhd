...
architecture behav of minus_vector26 is 
    ...
    signal mask_0_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal mask_0_ce0 : STD_LOGIC;
    signal mask_0_q0 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal mask_0_load_reg_337 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component minus_vector26_mabkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    mask_0_U : component minus_vector26_mabkb
    generic map (
        DataWidth => 1,
        AddressRange => 784,
        AddressWidth => 10)
    ...
    mask_0_address0 <= sum_cast_fu_234_p1(10 - 1 downto 0);

    mask_0_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
    ...
    tmp_fu_247_p2 <= (tmp_2_reg_332 xor mask_0_load_reg_337);
