...
architecture behav of minus_vector27 is 
    ...
    signal mask_1_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal mask_1_ce0 : STD_LOGIC;
    signal mask_1_q0 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal mask_1_load_reg_337 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component minus_vector27_macud IS
    generic (
        DataWidth : INTEGER;
...
begin
    mask_1_U : component minus_vector27_macud
    generic map (
        DataWidth => 1,
        AddressRange => 784,
        AddressWidth => 10)
    ...
    mask_1_address0 <= sum_cast_fu_234_p1(10 - 1 downto 0);

    mask_1_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter1)
    begin
    ...
    tmp_fu_247_p2 <= (tmp_2_reg_332 xor mask_1_load_reg_337);
