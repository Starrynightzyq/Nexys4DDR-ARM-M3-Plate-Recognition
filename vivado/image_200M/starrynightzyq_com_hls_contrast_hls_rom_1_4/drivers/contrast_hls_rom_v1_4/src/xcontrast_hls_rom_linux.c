...
typedef struct {
    ...
    XContrast_hls_rom_uio_map maps[ MAX_UIO_MAPS ];
} XContrast_hls_rom_uio_info;

/***************** Variable Definitions **************************************/
static XContrast_hls_rom_uio_info uio_info;
...
static int uio_info_read_name(XContrast_hls_rom_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XContrast_hls_rom_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XContrast_hls_rom_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XContrast_hls_rom_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XContrast_hls_rom_Initialize(XContrast_hls_rom *InstancePtr, const char* InstanceName) {
	XContrast_hls_rom_uio_info *InfoPtr = &uio_info;
