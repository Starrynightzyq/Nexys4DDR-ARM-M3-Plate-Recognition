...
output  [5:0] img_rows_V_out_din;
input   img_rows_V_out_full_n;
output   img_rows_V_out_write;
output  [5:0] img_cols_V_out_din;
...
reg   [0:0] exitcond_i_reg_440;
reg   [0:0] brmerge_i_reg_449;
wire    ap_CS_fsm_pp2_stage0;
reg    ap_enable_reg_pp2_iter1;
wire    ap_block_pp2_stage0;
reg   [0:0] eol_2_i_reg_303;
...
reg   [0:0] eol_i_reg_243;
reg   [0:0] eol_reg_255;
reg   [7:0] axi_data_V_1_i_reg_266;
reg   [0:0] axi_last_V_3_i_reg_314;
reg   [7:0] axi_data_V_3_i_reg_326;
...
reg   [7:0] tmp_data_V_reg_411;
reg   [0:0] tmp_last_V_reg_419;
wire   [0:0] exitcond3_i_fu_365_p2;
...
reg   [0:0] ap_phi_mux_eol_2_i_phi_fu_306_p4;
reg   [0:0] axi_last_V1_i_reg_201;
wire    ap_CS_fsm_state10;
wire    ap_CS_fsm_state3;
reg   [7:0] axi_data_V1_i_reg_211;
reg   [31:0] t_V_reg_221;
reg   [0:0] ap_phi_mux_eol_i_phi_fu_247_p4;
reg   [0:0] ap_phi_mux_axi_last_V_2_i_phi_fu_282_p4;
reg   [7:0] ap_phi_mux_p_Val2_s_phi_fu_294_p4;
wire   [0:0] ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_277;
wire   [7:0] ap_phi_reg_pp1_iter1_p_Val2_s_reg_290;
reg    ap_block_pp1_stage0_01001;
reg   [0:0] sof_1_i_fu_144;
wire  signed [5:0] rows_V_fu_348_p0;
wire  signed [5:0] cols_V_fu_352_p0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond3_i_fu_365_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_376_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond3_i_fu_365_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_phi_mux_eol_2_i_phi_fu_306_p4 == 1'd1) & (1'b0 == ap_block_pp2_stage0_subdone) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
            ap_enable_reg_pp2_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_440 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((eol_2_i_reg_303 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_376_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_144 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_376_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_reg_303 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op71_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond3_i_fu_365_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_521)) begin
        if ((brmerge_i_reg_449 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_282_p4 = eol_reg_255;
        end else if ((brmerge_i_reg_449 == 1'd0)) begin
...
always @ (*) begin
    if (((eol_2_i_reg_303 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_440 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_303 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_449 == 1'd0) & (exitcond_i_reg_440 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_356_p1 == 1'd0) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((tmp_user_V_fu_356_p1 == 1'd1) & (1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0))));
end

assign ap_block_pp2_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp2_stage0_11001 = ((eol_2_i_reg_303 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp2_stage0_subdone = ((eol_2_i_reg_303 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_enable_reg_pp2_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op71_read_state6 == 1'b1)) | ((exitcond_i_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0)));
end

assign ap_block_state8_pp2_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp2_stage0_iter1 = ((eol_2_i_reg_303 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_0_vld_out));
end

always @ (*) begin
    ap_condition_521 = ((exitcond_i_reg_440 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
assign ap_phi_reg_pp1_iter1_axi_last_V_2_i_reg_277 = 'bx;

assign ap_phi_reg_pp1_iter1_p_Val2_s_reg_290 = 'bx;

always @ (*) begin
    ap_predicate_op71_read_state6 = ((brmerge_i_reg_449 == 1'd0) & (exitcond_i_reg_440 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_390_p2 = (sof_1_i_fu_144 | ap_phi_mux_eol_i_phi_fu_247_p4);

assign cols_V_fu_352_p0 = img_cols_V_dout;

assign cols_V_fu_352_p1 = cols_V_fu_352_p0;

assign exitcond3_i_fu_365_p2 = ((t_V_reg_221 == rows_V_reg_401) ? 1'b1 : 1'b0);

assign exitcond_i_fu_376_p2 = ((t_V_3_reg_232 == cols_V_reg_406) ? 1'b1 : 1'b0);

assign i_V_fu_370_p2 = (t_V_reg_221 + 32'd1);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_V_din = ap_phi_mux_p_Val2_s_phi_fu_294_p4;

assign img_rows_V_out_din = img_rows_V_dout;

assign input_r_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];

assign j_V_fu_381_p2 = (t_V_3_reg_232 + 32'd1);
