...
port (
    ...
    src_rows_ap_vld : IN STD_LOGIC;
    src_cols_ap_vld : IN STD_LOGIC;
...
architecture behav of resize_axis is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "resize_axis,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.005625,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=2,HLS_SYN_DSP=25,HLS_SYN_FF=9433,HLS_SYN_LUT=8833,HLS_VERSION=2018_2}";
    ...
    signal Block_Mat_exit89_pro_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_start_out : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_write : STD_LOGIC;
    ...
    signal img_src_0_rows_V_c19_full_n : STD_LOGIC;
    signal img_src_0_rows_V_c19_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal img_src_0_rows_V_c19_empty_n : STD_LOGIC;
    signal img_src_0_cols_V_c20_full_n : STD_LOGIC;
    signal img_src_0_cols_V_c20_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal img_src_0_cols_V_c20_empty_n : STD_LOGIC;
    ...
    signal img_dst_0_rows_V_c21_full_n : STD_LOGIC;
    signal img_dst_0_rows_V_c21_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal img_dst_0_rows_V_c21_empty_n : STD_LOGIC;
    signal img_dst_0_cols_V_c22_full_n : STD_LOGIC;
    signal img_dst_0_cols_V_c22_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal img_dst_0_cols_V_c22_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit89_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit89_pro_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component Block_Mat_exit89_pro IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component resize_axis_AXILiteS_s_axi IS
    generic (
...
begin
    resize_axis_AXILiteS_s_axi_U : component resize_axis_AXILiteS_s_axi
    generic map (
    ...
    Block_Mat_exit89_pro_U0 : component Block_Mat_exit89_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Block_Mat_exit89_pro_U0_ap_start,
        start_full_n => Block_Mat_exit89_pro_U0_start_full_n,
        ap_done => Block_Mat_exit89_pro_U0_ap_done,
        ap_continue => Block_Mat_exit89_pro_U0_ap_continue,
        ap_idle => Block_Mat_exit89_pro_U0_ap_idle,
        ap_ready => Block_Mat_exit89_pro_U0_ap_ready,
        start_out => Block_Mat_exit89_pro_U0_start_out,
        start_write => Block_Mat_exit89_pro_U0_start_write,
        src_rows => src_rows,
        src_rows_ap_vld => src_rows_ap_vld,
        src_cols => src_cols,
        src_cols_ap_vld => src_cols_ap_vld,
        dst_rows => dst_rows,
        dst_cols => dst_cols,
        img_src_0_rows_V_out_din => Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_din,
        img_src_0_rows_V_out_full_n => img_src_0_rows_V_c_full_n,
        img_src_0_rows_V_out_write => Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_write,
        img_src_0_cols_V_out_din => Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_din,
        img_src_0_cols_V_out_full_n => img_src_0_cols_V_c_full_n,
        img_src_0_cols_V_out_write => Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_write,
        img_dst_0_rows_V_out_din => Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_din,
        img_dst_0_rows_V_out_full_n => img_dst_0_rows_V_c_full_n,
        img_dst_0_rows_V_out_write => Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_write,
        img_dst_0_cols_V_out_din => Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_din,
        img_dst_0_cols_V_out_full_n => img_dst_0_cols_V_c_full_n,
        img_dst_0_cols_V_out_write => Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_write,
        img_dst_1_rows_V_out_din => Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_din,
        img_dst_1_rows_V_out_full_n => img_dst_1_rows_V_c_full_n,
        img_dst_1_rows_V_out_write => Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_write,
        img_dst_1_cols_V_out_din => Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_din,
        img_dst_1_cols_V_out_full_n => img_dst_1_cols_V_c_full_n,
        img_dst_1_cols_V_out_write => Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_write);
    ...
    port map (
        ...
        img_rows_V_out_full_n => img_src_0_rows_V_c19_full_n,
        img_rows_V_out_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        img_cols_V_out_din => AXIvideo2Mat_U0_img_cols_V_out_din,
        img_cols_V_out_full_n => img_src_0_cols_V_c20_full_n,
    ...
    port map (
        ...
        p_src_rows_V_dout => img_src_0_rows_V_c19_dout,
        p_src_rows_V_empty_n => img_src_0_rows_V_c19_empty_n,
        p_src_rows_V_read => Resize_U0_p_src_rows_V_read,
        p_src_cols_V_dout => img_src_0_cols_V_c20_dout,
        p_src_cols_V_empty_n => img_src_0_cols_V_c20_empty_n,
        p_src_cols_V_read => Resize_U0_p_src_cols_V_read,
        p_src_data_stream_V_dout => img_src_0_data_strea_dout,
        p_src_data_stream_V_empty_n => img_src_0_data_strea_empty_n,
    ...
    port map (
        ...
        src_rows_V_dout => img_dst_0_rows_V_c21_dout,
        src_rows_V_empty_n => img_dst_0_rows_V_c21_empty_n,
        src_rows_V_read => Threshold_U0_src_rows_V_read,
        src_cols_V_dout => img_dst_0_cols_V_c22_dout,
        src_cols_V_empty_n => img_dst_0_cols_V_c22_empty_n,
    ...
    port map (
        ...
        if_din => Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_din,
        if_full_n => img_src_0_rows_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_din,
        if_full_n => img_src_0_cols_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_din,
        if_full_n => img_dst_0_rows_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_din,
        if_full_n => img_dst_0_cols_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_write,
        if_dout => img_dst_0_cols_V_c_dout,
        if_empty_n => img_dst_0_cols_V_c_empty_n,
        if_read => Resize_U0_p_dst_cols_V_read);

    img_dst_1_rows_V_c_U : component fifo_w16_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_din,
        if_full_n => img_dst_1_rows_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_write,
        if_dout => img_dst_1_rows_V_c_dout,
        if_empty_n => img_dst_1_rows_V_c_empty_n,
        if_read => Mat2AXIvideo_U0_img_rows_V_read);

    img_dst_1_cols_V_c_U : component fifo_w16_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_din,
        if_full_n => img_dst_1_cols_V_c_full_n,
        if_write => Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_write,
    ...
    img_src_0_rows_V_c19_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_src_0_rows_V_c19_full_n,
        if_write => AXIvideo2Mat_U0_img_rows_V_out_write,
        if_dout => img_src_0_rows_V_c19_dout,
        if_empty_n => img_src_0_rows_V_c19_empty_n,
        if_read => Resize_U0_p_src_rows_V_read);

    img_src_0_cols_V_c20_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_src_0_cols_V_c20_full_n,
        if_write => AXIvideo2Mat_U0_img_cols_V_out_write,
        if_dout => img_src_0_cols_V_c20_dout,
        if_empty_n => img_src_0_cols_V_c20_empty_n,
    ...
    img_dst_0_rows_V_c21_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_dst_0_rows_V_c21_full_n,
        if_write => Resize_U0_p_dst_rows_V_out_write,
        if_dout => img_dst_0_rows_V_c21_dout,
        if_empty_n => img_dst_0_rows_V_c21_empty_n,
        if_read => Threshold_U0_src_rows_V_read);

    img_dst_0_cols_V_c22_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_dst_0_cols_V_c22_full_n,
        if_write => Resize_U0_p_dst_cols_V_out_write,
        if_dout => img_dst_0_cols_V_c22_dout,
        if_empty_n => img_dst_0_cols_V_c22_empty_n,
    ...
    port map (
        ...
        if_write => Block_Mat_exit89_pro_U0_start_write,
    ...
    ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready <= ap_sync_Block_Mat_exit89_pro_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    Block_Mat_exit89_pro_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_Mat_exit89_pro_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_Mat_exit89_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit89_pro_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = Block_Mat_exit89_pro_U0_ap_ready) and (ap_sync_ready = ap_const_logic_0))) then 
                Block_Mat_exit89_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit89_pro_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit89_pro_U0_ap_continue <= ap_const_logic_1;
    Block_Mat_exit89_pro_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Block_Mat_exit89_pro_U0_start_full_n <= (start_for_Resize_U0_full_n and start_for_Mat2AXIvideo_U0_full_n);
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Threshold_U0_ap_idle and Resize_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Block_Mat_exit89_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit89_pro_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready or Block_Mat_exit89_pro_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Mat2AXIvideo_U0_ap_done;
    ap_sync_ready <= (ap_sync_Block_Mat_exit89_pro_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    input_r_TREADY <= AXIvideo2Mat_U0_input_r_TREADY;
    output_r_TDATA <= Mat2AXIvideo_U0_output_r_TDATA;
    output_r_TDEST <= Mat2AXIvideo_U0_output_r_TDEST;
    output_r_TID <= Mat2AXIvideo_U0_output_r_TID;
