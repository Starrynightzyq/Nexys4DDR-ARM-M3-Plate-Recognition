...
wire   [15:0] dst_rows;
wire   [15:0] dst_cols;
wire    Block_Mat_exit89_pro_U0_ap_start;
wire    Block_Mat_exit89_pro_U0_start_full_n;
wire    Block_Mat_exit89_pro_U0_ap_done;
wire    Block_Mat_exit89_pro_U0_ap_continue;
wire    Block_Mat_exit89_pro_U0_ap_idle;
wire    Block_Mat_exit89_pro_U0_ap_ready;
wire    Block_Mat_exit89_pro_U0_start_out;
wire    Block_Mat_exit89_pro_U0_start_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_src_0_rows_V_out_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_src_0_cols_V_out_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_dst_0_rows_V_out_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_dst_0_cols_V_out_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_dst_1_rows_V_out_write;
wire   [15:0] Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_din;
wire    Block_Mat_exit89_pro_U0_img_dst_1_cols_V_out_write;
...
wire    img_src_0_rows_V_c19_full_n;
wire   [15:0] img_src_0_rows_V_c19_dout;
wire    img_src_0_rows_V_c19_empty_n;
wire    img_src_0_cols_V_c20_full_n;
wire   [15:0] img_src_0_cols_V_c20_dout;
wire    img_src_0_cols_V_c20_empty_n;
wire    img_dst_0_data_strea_full_n;
wire   [7:0] img_dst_0_data_strea_dout;
wire    img_dst_0_data_strea_empty_n;
wire    img_dst_0_rows_V_c21_full_n;
wire   [15:0] img_dst_0_rows_V_c21_dout;
wire    img_dst_0_rows_V_c21_empty_n;
wire    img_dst_0_cols_V_c22_full_n;
wire   [15:0] img_dst_0_cols_V_c22_dout;
wire    img_dst_0_cols_V_c22_empty_n;
...
reg    ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready;
wire    ap_sync_Block_Mat_exit89_pro_U0_ap_ready;
reg   [1:0] Block_Mat_exit89_pro_U0_ap_ready_count;
...
#0 ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready = 1'b0;
#0 Block_Mat_exit89_pro_U0_ap_ready_count = 2'd0;
end

resize_axis_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
resize_axis_AXILiteS_s_axi_U(
...
Block_Mat_exit89_pro Block_Mat_exit89_pro_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
fifo_w16_d5_A img_dst_1_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d5_A img_dst_1_cols_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d2_A img_src_0_rows_V_c19_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d2_A img_src_0_cols_V_c20_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d2_A img_dst_0_rows_V_c21_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w16_d2_A img_dst_0_cols_V_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == Block_Mat_exit89_pro_U0_ap_ready) & (ap_sync_ready == 1'b1))) begin
        Block_Mat_exit89_pro_U0_ap_ready_count <= (Block_Mat_exit89_pro_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == Block_Mat_exit89_pro_U0_ap_ready) & (ap_sync_ready == 1'b0))) begin
        Block_Mat_exit89_pro_U0_ap_ready_count <= (Block_Mat_exit89_pro_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit89_pro_U0_ap_continue = 1'b1;

assign Block_Mat_exit89_pro_U0_ap_start = ((ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit89_pro_U0_start_full_n = (start_for_Resize_U0_full_n & start_for_Mat2AXIvideo_U0_full_n);
...
assign ap_idle = (Threshold_U0_ap_idle & Resize_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_Mat_exit89_pro_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit89_pro_U0_ap_ready = (ap_sync_reg_Block_Mat_exit89_pro_U0_ap_ready | Block_Mat_exit89_pro_U0_ap_ready);

assign ap_sync_continue = 1'b1;

assign ap_sync_done = Mat2AXIvideo_U0_ap_done;

assign ap_sync_ready = (ap_sync_Block_Mat_exit89_pro_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);
