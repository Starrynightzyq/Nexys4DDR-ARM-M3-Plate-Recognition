...
reg    ap_block_state1;
wire   [15:0] tmp_6_i_fu_194_p2;
wire   [15:0] tmp_8_i_fu_207_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (img_dst_0_cols_V_out_full_n == 1'b0) | (img_dst_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (bound_x_min_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (bound_x_max_ap_vld == 1'b0) | (bound_x_min_ap_vld == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (img_dst_0_cols_V_out_full_n == 1'b0) | (img_dst_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (bound_x_min_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (bound_x_max_ap_vld == 1'b0) | (bound_x_min_ap_vld == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign img_0_cols_V_out_din = (tmp_8_i_fu_207_p2 + bound_x_max);

assign img_0_rows_V_out_din = (tmp_6_i_fu_194_p2 + bound_y_max);
...
assign tmp_6_i_fu_194_p2 = (16'd1 - bound_y_min);

assign tmp_8_i_fu_207_p2 = (16'd1 - bound_x_min);
