...
module Block_Mat_exit2817_p (
        ...
        range_min_out_write,
        range_min_out1_din,
        range_min_out1_full_n,
        range_min_out1_write
);
...
output  [15:0] range_min_out1_din;
input   range_min_out1_full_n;
output   range_min_out1_write;
...
always @ (*) begin
    if ((~((1'b0 == Hdist_rows_V_out_full_n) | (img_1_bin_cols_V_out_full_n == 1'b0) | (img_1_bin_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (real_start == 1'b0) | (img_original_1_cols_V_out_full_n == 1'b0) | (img_original_1_rows_V_out_full_n == 1'b0) | (img_original_0_cols_V_out_full_n == 1'b0) | (img_original_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (range_min_out1_full_n == 1'b0) | (range_min_out_full_n == 1'b0) | (shrink_y_max_out_full_n == 1'b0) | (shrink_y_min_out_full_n == 1'b0) | (shrink_x_max_out_full_n == 1'b0) | (shrink_x_min_out_full_n == 1'b0) | (threshold_height_out_full_n == 1'b0) | (threshold_width_out_full_n == 1'b0) | (1'b0 == Vdist_cols_V_out_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        range_min_out1_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((1'b0 == Hdist_rows_V_out_full_n) | (img_1_bin_cols_V_out_full_n == 1'b0) | (img_1_bin_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (real_start == 1'b0) | (img_original_1_cols_V_out_full_n == 1'b0) | (img_original_1_rows_V_out_full_n == 1'b0) | (img_original_0_cols_V_out_full_n == 1'b0) | (img_original_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (range_min_out1_full_n == 1'b0) | (range_min_out_full_n == 1'b0) | (shrink_y_max_out_full_n == 1'b0) | (shrink_y_min_out_full_n == 1'b0) | (shrink_x_max_out_full_n == 1'b0) | (shrink_x_min_out_full_n == 1'b0) | (threshold_height_out_full_n == 1'b0) | (threshold_width_out_full_n == 1'b0) | (1'b0 == Vdist_cols_V_out_full_n) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        range_min_out1_write = 1'b1;
    end else begin
        range_min_out1_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((1'b0 == Hdist_rows_V_out_full_n) | (img_1_bin_cols_V_out_full_n == 1'b0) | (img_1_bin_rows_V_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (real_start == 1'b0) | (img_original_1_cols_V_out_full_n == 1'b0) | (img_original_1_rows_V_out_full_n == 1'b0) | (img_original_0_cols_V_out_full_n == 1'b0) | (img_original_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (img_0_rows_V_out_full_n == 1'b0) | (range_min_out1_full_n == 1'b0) | (range_min_out_full_n == 1'b0) | (shrink_y_max_out_full_n == 1'b0) | (shrink_y_min_out_full_n == 1'b0) | (shrink_x_max_out_full_n == 1'b0) | (shrink_x_min_out_full_n == 1'b0) | (threshold_height_out_full_n == 1'b0) | (threshold_width_out_full_n == 1'b0) | (1'b0 == Vdist_cols_V_out_full_n) | (ap_done_reg == 1'b1));
end
...
assign range_min_out1_din = range_min;
