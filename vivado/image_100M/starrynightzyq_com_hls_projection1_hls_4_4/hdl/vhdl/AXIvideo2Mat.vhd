...
architecture behav of AXIvideo2Mat is 
    ...
    signal t_V_7_reg_232 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    t_V_7_reg_232_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_fu_368_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                t_V_7_reg_232 <= j_V_fu_373_p2;
            elsif (((exitcond6_i_fu_357_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                t_V_7_reg_232 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;
    ...
    exitcond_i_fu_368_p2 <= "1" when (t_V_7_reg_232 = cols_V_reg_398) else "0";
    ...
    j_V_fu_373_p2 <= std_logic_vector(unsigned(t_V_7_reg_232) + unsigned(ap_const_lv32_1));
