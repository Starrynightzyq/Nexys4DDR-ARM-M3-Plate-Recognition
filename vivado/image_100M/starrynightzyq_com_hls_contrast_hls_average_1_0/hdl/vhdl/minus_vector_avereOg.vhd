...
entity minus_vector_avereOg_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 10; 
...
architecture rtl of minus_vector_avereOg_rom is 
...
entity minus_vector_avereOg is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of minus_vector_avereOg is
    component minus_vector_avereOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    minus_vector_avereOg_rom_U :  component minus_vector_avereOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
