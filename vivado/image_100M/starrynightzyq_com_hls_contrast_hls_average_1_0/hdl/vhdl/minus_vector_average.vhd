...
entity minus_vector_average is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of minus_vector_average is 
    ...
    signal mask_9_load_reg_398 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_38_fu_331_p1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal tmp_10_fu_239_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component minus_vector_averlbW IS
    generic (
        DataWidth : INTEGER;
...
begin
    mask_9_U : component minus_vector_averlbW
    generic map (
        DataWidth => 1,
        AddressRange => 784,
        AddressWidth => 10)
    ...
    contrast_hls_avercud_U66 : component contrast_hls_avercud
    generic map (
        ID => 1,
        NUM_STAGE => 24,
        din0_WIDTH => 20,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter25 = ap_const_logic_1) and (or_cond_reg_389_pp0_iter24_reg = ap_const_lv1_1))) then 
                    normal_dst_V_preg <= tmp_38_fu_331_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    mask_9_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter0)
    begin
    ...
    normal_dst_V_assign_proc : process(or_cond_reg_389_pp0_iter24_reg, ap_enable_reg_pp0_iter25, tmp_38_fu_331_p1, normal_dst_V_preg, ap_block_pp0_stage0_01001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_01001) and (ap_enable_reg_pp0_iter25 = ap_const_logic_1) and (or_cond_reg_389_pp0_iter24_reg = ap_const_lv1_1))) then 
            normal_dst_V <= tmp_38_fu_331_p1;
        else 
    ...
    or_cond_fu_245_p2 <= (tmp_6_reg_359 and tmp_10_fu_239_p2);
    p_0255_2_fu_289_p3 <= 
    ...
    tmp_10_fu_239_p2 <= "1" when (t_V_1_reg_132 = ap_const_lv5_1B) else "0";
    tmp_2_fu_250_p2 <= "0" when (src_data_stream_V_dout = ap_const_lv8_0) else "1";
    tmp_38_fu_331_p1 <= grp_fu_315_p2(12 - 1 downto 0);
    ...
    tmp_8_fu_280_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(mask_9_load_reg_398),10));
    tmp_9_fu_213_p2 <= (t_V_reg_120 or t_V_1_reg_132);
    tmp_fu_262_p2 <= (tmp_2_reg_393 xor mask_9_load_reg_398);
