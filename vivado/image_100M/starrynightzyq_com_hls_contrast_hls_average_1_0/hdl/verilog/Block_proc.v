...
output   ap_idle;
output   ap_ready;
output  [5:0] img_src_0_rows_V_out_din;
input   img_src_0_rows_V_out_full_n;
output   img_src_0_rows_V_out_write;
output  [5:0] img_src_0_cols_V_out_din;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (img_src_0_cols_V_out_full_n == 1'b0) | (img_src_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (img_src_0_cols_V_out_full_n == 1'b0) | (img_src_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (img_src_0_cols_V_out_full_n == 1'b0) | (img_src_0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign img_src_0_cols_V_out_din = 6'd28;

assign img_src_0_rows_V_out_din = 6'd28;
