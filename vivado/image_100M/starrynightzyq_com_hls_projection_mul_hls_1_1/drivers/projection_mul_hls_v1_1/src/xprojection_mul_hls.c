...
void XProjection_mul_hls_Set_range_min(XProjection_mul_hls *InstancePtr, u32 Data) {
    ...
    XProjection_mul_hls_WriteReg(InstancePtr->Axilites_BaseAddress, XPROJECTION_MUL_HLS_AXILITES_ADDR_RANGE_MIN_DATA, Data);
}
...
u32 XProjection_mul_hls_Get_range_min(XProjection_mul_hls *InstancePtr) {
    ...
    Data = XProjection_mul_hls_ReadReg(InstancePtr->Axilites_BaseAddress, XPROJECTION_MUL_HLS_AXILITES_ADDR_RANGE_MIN_DATA);
    return Data;
}
...
void XProjection_mul_hls_Set_range_max(XProjection_mul_hls *InstancePtr, u32 Data) {
    ...
    XProjection_mul_hls_WriteReg(InstancePtr->Axilites_BaseAddress, XPROJECTION_MUL_HLS_AXILITES_ADDR_RANGE_MAX_DATA, Data);
}
...
u32 XProjection_mul_hls_Get_range_max(XProjection_mul_hls *InstancePtr) {
    ...
    Data = XProjection_mul_hls_ReadReg(InstancePtr->Axilites_BaseAddress, XPROJECTION_MUL_HLS_AXILITES_ADDR_RANGE_MAX_DATA);
    return Data;
}
