...
wire   [16:0] tmp_9_cast_cast_i_fu_229_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
assign axi_last_V_fu_233_p2 = ((tmp_9_cast_cast_i_fu_229_p1 == r_V_reg_264) ? 1'b1 : 1'b0);

assign exitcond2_i_fu_207_p2 = ((t_V_reg_170 == img_rows_V_read_reg_254) ? 1'b1 : 1'b0);

assign exitcond_i_fu_218_p2 = ((t_V_2_reg_181 == img_cols_V_read_reg_259) ? 1'b1 : 1'b0);

assign i_V_fu_212_p2 = (t_V_reg_170 + 16'd1);

assign j_V_fu_223_p2 = (t_V_2_reg_181 + 16'd1);
...
assign tmp_9_cast_cast_i_fu_229_p1 = t_V_2_reg_181;
