...
architecture behav of draw_line_hls is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "draw_line_hls,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.419000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1224,HLS_SYN_LUT=2720,HLS_VERSION=2018_2}";
    ...
    signal box_num : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_Mat_exit88_pro_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_start_out : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_img_1_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit88_pro_U0_img_1_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_img_1_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit88_pro_U0_img_1_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_img_2_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit88_pro_U0_img_2_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_img_2_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit88_pro_U0_img_2_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_bound_y_min_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit88_pro_U0_bound_y_min_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_bound_y_max_out_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_Mat_exit88_pro_U0_bound_y_max_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_box_num_out_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Block_Mat_exit88_pro_U0_box_num_out_write : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_return_0 : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit88_pro_U0_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal draw_line_U0_ap_start : STD_LOGIC;
    signal draw_line_U0_ap_done : STD_LOGIC;
    signal draw_line_U0_ap_continue : STD_LOGIC;
    signal draw_line_U0_ap_idle : STD_LOGIC;
    signal draw_line_U0_ap_ready : STD_LOGIC;
    signal draw_line_U0_src_data_stream_V_read : STD_LOGIC;
    signal draw_line_U0_dst_rows_V_read : STD_LOGIC;
    signal draw_line_U0_dst_cols_V_read : STD_LOGIC;
    signal draw_line_U0_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal draw_line_U0_dst_data_stream_V_write : STD_LOGIC;
    signal draw_line_U0_bound_x_min_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal draw_line_U0_bound_x_min_ce0 : STD_LOGIC;
    signal draw_line_U0_bound_x_max_address0 : STD_LOGIC_VECTOR (2 downto 0);
    signal draw_line_U0_bound_x_max_ce0 : STD_LOGIC;
    signal draw_line_U0_bound_y_min_read : STD_LOGIC;
    signal draw_line_U0_bound_y_max_read : STD_LOGIC;
    signal draw_line_U0_box_num_read : STD_LOGIC;
    signal draw_middle_line_U0_ap_start : STD_LOGIC;
    signal draw_middle_line_U0_ap_done : STD_LOGIC;
    signal draw_middle_line_U0_ap_continue : STD_LOGIC;
    signal draw_middle_line_U0_ap_idle : STD_LOGIC;
    signal draw_middle_line_U0_ap_ready : STD_LOGIC;
    signal draw_middle_line_U0_start_out : STD_LOGIC;
    signal draw_middle_line_U0_start_write : STD_LOGIC;
    signal draw_middle_line_U0_src_data_stream_V_read : STD_LOGIC;
    signal draw_middle_line_U0_dst_rows_V_read : STD_LOGIC;
    signal draw_middle_line_U0_dst_cols_V_read : STD_LOGIC;
    signal draw_middle_line_U0_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal draw_middle_line_U0_dst_data_stream_V_write : STD_LOGIC;
    signal draw_middle_line_U0_dst_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal draw_middle_line_U0_dst_rows_V_out_write : STD_LOGIC;
    signal draw_middle_line_U0_dst_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal draw_middle_line_U0_dst_cols_V_out_write : STD_LOGIC;
    ...
    signal box_num_c_full_n : STD_LOGIC;
    signal box_num_c_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal box_num_c_empty_n : STD_LOGIC;
    ...
    signal img_2_rows_V_c18_full_n : STD_LOGIC;
    signal img_2_rows_V_c18_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal img_2_rows_V_c18_empty_n : STD_LOGIC;
    signal img_2_cols_V_c19_full_n : STD_LOGIC;
    signal img_2_cols_V_c19_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal img_2_cols_V_c19_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit88_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit88_pro_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal ap_sync_reg_draw_line_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_draw_line_U0_ap_ready : STD_LOGIC;
    signal draw_line_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal start_for_draw_middle_line_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_draw_middle_line_U0_full_n : STD_LOGIC;
    signal start_for_draw_middle_line_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_draw_middle_line_U0_empty_n : STD_LOGIC;
    signal AXIvideo2Mat_U0_start_full_n : STD_LOGIC;
    signal AXIvideo2Mat_U0_start_write : STD_LOGIC;
    signal draw_line_U0_start_full_n : STD_LOGIC;
    signal draw_line_U0_start_write : STD_LOGIC;
    ...
    component Block_Mat_exit88_pro IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ...
        bound_y_max : IN STD_LOGIC_VECTOR (15 downto 0);
        bound_y_max_ap_vld : IN STD_LOGIC;
        box_num : IN STD_LOGIC_VECTOR (7 downto 0);
        ...
        box_num_out_din : OUT STD_LOGIC_VECTOR (7 downto 0);
        box_num_out_full_n : IN STD_LOGIC;
        box_num_out_write : OUT STD_LOGIC;
    ...
    component start_for_draw_mibkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component draw_line_hls_AXILiteS_s_axi IS
    generic (
    ...
    port (
        ...
        box_num : OUT STD_LOGIC_VECTOR (7 downto 0) );
    end component;



begin
    draw_line_hls_AXILiteS_s_axi_U : component draw_line_hls_AXILiteS_s_axi
    generic map (
    ...
    Block_Mat_exit88_pro_U0 : component Block_Mat_exit88_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    draw_line_U0 : component draw_line
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    draw_middle_line_U0 : component draw_middle_line
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    box_num_c_U : component fifo_w8_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_2_rows_V_c18_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_2_cols_V_c19_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_draw_mibkb_U : component start_for_draw_mibkb
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((Block_Mat_exit88_pro_U0_ap_done and Block_Mat_exit88_pro_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_img_0_cols_V_channel <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_draw_line_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_draw_line_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_draw_line_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    Block_Mat_exit88_pro_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_Mat_exit88_pro_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_Mat_exit88_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit88_pro_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Block_Mat_exit88_pro_U0_ap_ready))) then 
                Block_Mat_exit88_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit88_pro_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;

    draw_line_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((draw_line_U0_ap_ready = ap_const_logic_0) and (ap_sync_ready = ap_const_logic_1))) then 
                draw_line_U0_ap_ready_count <= std_logic_vector(unsigned(draw_line_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (draw_line_U0_ap_ready = ap_const_logic_1))) then 
                draw_line_U0_ap_ready_count <= std_logic_vector(unsigned(draw_line_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit88_pro_U0_ap_continue <= (ap_sync_channel_write_img_0_rows_V_channel and ap_sync_channel_write_img_0_cols_V_channel);
    Block_Mat_exit88_pro_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Mat2AXIvideo_U0_ap_continue <= ap_const_logic_1;
    Mat2AXIvideo_U0_ap_start <= start_for_Mat2AXIvideo_U0_empty_n;
    Mat2AXIvideo_U0_start_full_n <= ap_const_logic_1;
    Mat2AXIvideo_U0_start_write <= ap_const_logic_0;
    ap_channel_done_img_0_cols_V_channel <= ((ap_sync_reg_channel_write_img_0_cols_V_channel xor ap_const_logic_1) and Block_Mat_exit88_pro_U0_ap_done);
    ap_channel_done_img_0_rows_V_channel <= ((ap_sync_reg_channel_write_img_0_rows_V_channel xor ap_const_logic_1) and Block_Mat_exit88_pro_U0_ap_done);
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((img_0_cols_V_channel_empty_n xor ap_const_logic_1) and (img_0_rows_V_channel_empty_n xor ap_const_logic_1) and draw_middle_line_U0_ap_idle and draw_line_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Block_Mat_exit88_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit88_pro_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit88_pro_U0_ap_ready or Block_Mat_exit88_pro_U0_ap_ready);
    ...
    ap_sync_draw_line_U0_ap_ready <= (draw_line_U0_ap_ready or ap_sync_reg_draw_line_U0_ap_ready);
    ap_sync_ready <= (ap_sync_draw_line_U0_ap_ready and ap_sync_Block_Mat_exit88_pro_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
    bound_max_address0 <= draw_line_U0_bound_x_max_address0;
    bound_max_ce0 <= draw_line_U0_bound_x_max_ce0;
    bound_max_d0 <= ap_const_lv16_0;
    bound_max_we0 <= ap_const_logic_0;
    bound_min_address0 <= draw_line_U0_bound_x_min_address0;
    bound_min_ce0 <= draw_line_U0_bound_x_min_ce0;
    bound_min_d0 <= ap_const_lv16_0;
    bound_min_we0 <= ap_const_logic_0;
    draw_line_U0_ap_continue <= ap_const_logic_1;
    draw_line_U0_ap_start <= ((ap_sync_reg_draw_line_U0_ap_ready xor ap_const_logic_1) and ap_start);
    draw_line_U0_start_full_n <= ap_const_logic_1;
    draw_line_U0_start_write <= ap_const_logic_0;
    draw_middle_line_U0_ap_continue <= ap_const_logic_1;
    draw_middle_line_U0_ap_start <= start_for_draw_middle_line_U0_empty_n;
    input_r_TREADY <= AXIvideo2Mat_U0_input_r_TREADY;
    output_r_TDATA <= Mat2AXIvideo_U0_output_r_TDATA;
    output_r_TDEST <= Mat2AXIvideo_U0_output_r_TDEST;
    output_r_TID <= Mat2AXIvideo_U0_output_r_TID;
    ...
    start_for_draw_middle_line_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
