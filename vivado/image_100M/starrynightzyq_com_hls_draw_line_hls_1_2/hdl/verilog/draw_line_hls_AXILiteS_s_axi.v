...
`timescale 1ns/1ps
module draw_line_hls_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_BOX_NUM_DATA_0 = 6'h20,
    ADDR_BOX_NUM_CTRL   = 6'h24,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_BOX_NUM_DATA_0: begin
                    rdata <= int_box_num[7:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_BOX_NUM_DATA_0)
            int_box_num[7:0] <= (WDATA[31:0] & wmask) | (int_box_num[7:0] & ~wmask);
    end
end
