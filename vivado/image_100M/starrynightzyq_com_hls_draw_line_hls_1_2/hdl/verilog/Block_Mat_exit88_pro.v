...
output  [7:0] box_num_out_din;
input   box_num_out_full_n;
output   box_num_out_write;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((box_num_out_full_n == 1'b0) | (real_start == 1'b0) | (bound_y_max_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((box_num_out_full_n == 1'b0) | (real_start == 1'b0) | (bound_y_max_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        box_num_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((box_num_out_full_n == 1'b0) | (real_start == 1'b0) | (bound_y_max_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        box_num_out_write = 1'b1;
    end else begin
        box_num_out_write = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_state1 = ((box_num_out_full_n == 1'b0) | (real_start == 1'b0) | (bound_y_max_out_full_n == 1'b0) | (bound_y_min_out_full_n == 1'b0) | (img_2_cols_V_out_full_n == 1'b0) | (img_2_rows_V_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (bound_y_max_ap_vld == 1'b0) | (bound_y_min_ap_vld == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign box_num_out_din = box_num;
